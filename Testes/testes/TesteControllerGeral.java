...
class TesteControllerGeral {
	...
	void testVotarComissao() {
		...
		assertFalse(controllerGeral.votarComissao("PLP 1/2017", "LIVRE", "CTF"));
		assertFalse(controllerGeral.votarComissao("PLP 1/2017", "LIVRE", "plenario"));
		assertTrue(controllerGeral.votarComissao("PLP 2/2017", "GOVERNISTA", "CTF"));
		assertTrue(controllerGeral.votarComissao("PLP 2/2017", "GOVERNISTA", "plenario"));
		assertFalse(controllerGeral.votarComissao("PLP 3/2017", "OPOSICAO", "CTF"));
		assertFalse(controllerGeral.votarComissao("PLP 3/2017", "OPOSICAO", "plenario"));
		
		
		assertFalse(controllerGeral.votarComissao("PEC 1/2017", "LIVRE", "CTF"));
		assertFalse(controllerGeral.votarComissao("PEC 1/2017", "LIVRE", "plenario"));
		assertTrue(controllerGeral.votarComissao("PEC 2/2017", "GOVERNISTA", "CTF"));
		assertTrue(controllerGeral.votarComissao("PEC 2/2017", "GOVERNISTA", "plenario"));
		assertFalse(controllerGeral.votarComissao("PEC 3/2017", "OPOSICAO", "CTF"));
		assertFalse(controllerGeral.votarComissao("PEC 3/2017", "OPOSICAO", "plenario"));
		
		assertTrue(controllerGeral.votarComissao("PL 1/2017", "LIVRE", "CTF"));
		...
		assertTrue(controllerGeral.votarComissao("PL 1/2017", "LIVRE", "plenario"));
		assertFalse(controllerGeral.votarComissao("PL 2/2017", "OPOSICAO", "CTF"));
		assertTrue(controllerGeral.votarComissao("PL 3/2017", "GOVERNISTA", "CTF"));
	...
	void testExibirTramitacao() {
		...
		controllerGeral.votarComissao("PL 1/2017", "LIVRE", "CTF");
		assertEquals(controllerGeral.exibirTramitacao("PL 1/2017"), "APROVADO (CCJC)");
		controllerGeral.votarComissao("PL 1/2017", "LIVRE", "plenario");
		assertEquals(controllerGeral.exibirTramitacao("PL 1/2017"), "APROVADO (CCJC), APROVADO (CTF)");
		controllerGeral.votarPlenario("PL 1/2017", "LIVRE", "111111111-1,111111111-2,111111111-3,111111111-4,111111111-5,111111111-6,111111111-7");
		//assertEquals(controllerGeral.exibirTramitacao("PL 1/2017"), "APROVADO (CCJC), APROVADO (CTF), APROVADO (Plenario 1o turno), EM VOTACAO (Plenario 2o turno)");
		assertEquals(controllerGeral.exibirTramitacao("PL 1/2017"), "APROVADO (CCJC), APROVADO (CTF), APROVADO (Plenario), EM VOTACAO (plenario)");
		
		controllerGeral.votarComissao("PEC 1/2017", "LIVRE", "CTF");
		//assertEquals(controllerGeral.exibirTramitacao("PEC 1/2017"), "REPROVADO (CCJC)");
		controllerGeral.votarComissao("PEC 1/2017", "LIVRE", "plenario");
		//assertEquals(controllerGeral.exibirTramitacao("PEC 1/2017"), "REPROVADO (CCJC), REPROVADO (CTF)");
		controllerGeral.votarPlenario("PEC 1/2017", "GOVERNISTA", "111111111-1,111111111-2,111111111-3,111111111-4,111111111-5,111111111-6,111111111-7");
		//assertEquals(controllerGeral.exibirTramitacao("PL 1/2017"), "APROVADO (CCJC), APROVADO (CTF), APROVADO (Plenario 1o turno), EM VOTACAO (Plenario 2o turno)");
		assertEquals(controllerGeral.exibirTramitacao("PEC 1/2017"), "REPROVADO (CCJC), REPROVADO (CTF), APROVADO (Plenario - 1o turno), EM VOTACAO (Plenario - 2o turno)");
		controllerGeral.votarPlenario("PEC 1/2017", "LIVRE", "111111111-1,111111111-2,111111111-3,111111111-4,111111111-5,111111111-6,111111111-7");
		//assertEquals(controllerGeral.exibirTramitacao("PEC 1/2017"), "REPROVADO (CCJC), REPROVADO (CTF), APROVADO (Plenario - 1o turno), REPROVADO (Plenario - 2o turno)");
		
		assertThrows(IllegalArgumentException.class, ()-> controllerGeral.exibirTramitacao("kk"), "Erro ao exibir tramitacao: projeto inexistente");
		assertThrows(IllegalArgumentException.class, ()-> controllerGeral.exibirTramitacao(""), "Erro ao exibir tramitacao: codigo nao poder ser vazio ou nulo");
