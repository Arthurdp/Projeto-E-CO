...
class testePEC {
	...
	@Test
	void testToString() {
		pec1 = new PEC("111111111-1", 2019, 88 , "permite o aluno de lp2 desistir da us7", "saude, bem comum", "http://example.com/num_vai_dar_naum", "10,11,12,13");
		pec2 = new PEC("111111111-1", 2019, 99 , "10 automatico pra quem fizer a us7", "justica", "http://example.com/seria_uma_boa", "9,11,12,13");
