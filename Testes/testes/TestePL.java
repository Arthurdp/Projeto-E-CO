...
class TestePL {
	...
	@Test
	void testToString() {
		PL plTeste = new PL("111111111-1", 2018, "PL 3/2018", "proibir a us7", "Saude", "http://example.com/namoralzinha_vei", true);
		PL plTeste2 = new PL("111111111-1", 2018, "PL 7/2018", "anular a us7", "Saude", "http://example.com/não ta dando", false);
